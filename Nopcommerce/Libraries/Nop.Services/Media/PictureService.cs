...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        /// <param name="defaultPictureType">Default picture type</param>
        /// <returns>Picture URL</returns>
        public virtual string GetPictureUrlOfNews(Picture picture,
            int targetSize = 0,
            bool showDefaultPicture = true,
            string storeLocation = null,
            PictureType defaultPictureType = PictureType.Entity)
        ...
        /// </summary>
        /// <param name="picture">Picture</param>
        public virtual bool DeletePicture(int pictureId)
        {
            var picture = GetPictureById(pictureId);
            if (picture != null)
            {
        ...
        /// </summary>
        /// <param name="newsId">newsId identifier</param>
        /// <param name="recordsToReturn">Number of records to return. 0 if you want to get all items</param>
        /// <returns>Pictures</returns>
        public virtual IList<Picture> GetPicturesByNewsId(int newsId, int recordsToReturn = 0)
        {
            if (newsId == 0)
                return new List<Picture>();

            var query = from p in _pictureRepository.Table
                        join pp in _newsPictureRepository.Table on p.Id equals pp.PictureId
        ...
        /// <param name="seoFilename">The SEO filename</param>
        /// <returns>Picture</returns>
        public virtual Picture SetSeoFilenameOfNews(int pictureId, string seoFilename)
        {
            var picture = GetPictureById(pictureId);
            if (picture == null)
                throw new ArgumentException("No picture found with the specified id");
